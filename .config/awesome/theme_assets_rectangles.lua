...
--- Generate selected taglist rectangle.
-- @tparam number width Width.
-- @tparam number height Height.
-- @tparam color fg Background color.
-- @return Image with the rectangle.
-- @staticfct beautiful.theme_assets.taglist_rect_sel
function theme_assets.taglist_rect_sel(width, height, fg)
...
--- Generate unselected taglist rectangle.
-- @tparam number width Width.
-- @tparam number height Height.
-- @tparam color fg Background color.
-- @return Image with the rectangle.
-- @staticfct beautiful.theme_assets.taglist_rect_unsel
function theme_assets.taglist_rect_unsel(width, height, fg)
    local img = cairo.ImageSurface(cairo.Format.ARGB32, width, height)
    local cr = cairo.Context(img)
    cr:set_source(gears_color(fg))
